...
export const WithLiveAndGithubLinks = Template.bind({});
WithLiveAndGithubLinks.args = {
  project: {
    title: 'Another Great Project',
    slug: 'another-great-project',
    shortDescription: 'This project has live and GitHub links.',
    description: {
      root: {
        direction: 'ltr',
        format: '',
    ...
    thumbnail: { url: 'https://via.placeholder.com/420x304' },
    liveProjectUrl: 'https://live-project.example.com',
